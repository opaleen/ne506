...
def generate_model(control_drum_rotation_angle):
    ...
    assembly_1.universes = [
        [fuel_12_rod, heat_pipe] * 6,
        [fuel_12_rod] * 6,
        [control_rod],
    ]
    ...
    assembly_2.universes = [
        [fuel_15_rod, heat_pipe] * 6,
        [fuel_15_rod] * 6,
        [heat_pipe],
    ]
    ...
    assembly_3.universes = [
        [fuel_19_rod, heat_pipe] * 6,
        [fuel_19_rod] * 6,
        [heat_pipe],
    ]
